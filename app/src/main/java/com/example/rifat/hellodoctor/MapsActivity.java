...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public static String place_name,catagory_name,datee;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        place_name=getIntent().getStringExtra("PLACE");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.showlist:
            {
                Intent inti=new Intent(getApplicationContext(),listing.class);
                ...
                inti.putExtra("CATAGORY",catagory_name);
                inti.putExtra("DATE",datee);
                startActivity(inti);
            }
            break;
        }
    ...
    public void onLocationChanged(Location location) {
        ...
        if (!place_name.equals("")) {
            ...
            mMap.addMarker(mo);
            mMap.animateCamera(CameraUpdateFactory.newLatLng(latlng));
            Toast.makeText(MapsActivity.this, ""+place_name+"", Toast.LENGTH_LONG).show();
            latitude=myaddress.getLatitude();
            longitude=myaddress.getLongitude();
            //}
        }
